...
if ARGV.size == 0
  # puts "Usage: ruby #{__FILE__} ImageToFindTargetIn"
  exit
end

window = GUI::Window.new(ARGV[0])
lower_bound = 10
upper_bound = 100
t = window.set_trackbar("lower_bound", 200, 60) { |v| lower_bound = v}
t = window.set_trackbar("upper_bound", 500, 255) { |v| upper_bound = v}
...
canny = gray.canny(lower_bound, upper_bound)
